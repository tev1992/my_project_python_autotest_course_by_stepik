...
class ProductPage(BasePage):
    ...
    def should_be_add_to_basket(self):
        assert self.is_element_present(*ProductPageLocators.BUTTON_ADD_TO_BASKET), 'Кнопка "Добавить в корзину" не отображается на странице'
    ...
    def message_product_added_to_basket(self): #language
        ...
        actual_messege = self.browser.find_element(*ProductPageLocators.MESSAGE_PRODUCT_ADDED).text #(self.PRODUCT_ADDED_MESSAGES.get(language, self.PRODUCT_ADDED_MESSAGES))
